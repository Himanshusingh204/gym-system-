        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-[72px]">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              <img src="/logo.png" alt="Vajra Fitness" className="h-9 w-auto group-hover:scale-105 transition-transform duration-300" />
            ...
            <div className="hidden md:flex items-center gap-1 lg:gap-2">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-56 glass-strong rounded-xl overflow-hidden opacity-0 invisible translate-y-2 transition-all duration-200 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 focus-within:opacity-100 focus-within:visible focus-within:translate-y-0 group-hover:z-50">
